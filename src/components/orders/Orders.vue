<template>
  <div>
    ...
    <el-card>
      ...
      <el-table :data="orderList" border style="width: 100%" stripe>
        ...
        <el-table-column label="操作" width="300">
          <template v-slot="scope">
            <el-button type="primary" icon="el-icon-edit" size="small" @click="setDialogVisible = true"></el-button>
            <el-button type="success" icon="el-icon-location" size="small" @click="getProgress"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <!-- 修改地址对话框 -->
    <el-dialog title="修改地址" :visible.sync="setDialogVisible" width="50%" @close="addressClean">
